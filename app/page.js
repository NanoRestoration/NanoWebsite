  ...
  return (
    <div className="w-lvw pt-24">
      <main className="bg-midnight-blue z-10">
        <section
          id="Home"
          className="pt-10 h-[50rem] w-full flex flex-col justify-start gap-20 max-md:gap-10 items-center sm:text-4xl text-2xl font-semibold bg-[url(/Roof-Spray-2.PNG)] bg-cover"
        >
