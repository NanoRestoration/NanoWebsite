        ...
        <section id="extremeWeather" className="w-full py-20">
          <div className="flex justify-evenly my-10 m-auto md:flex-row flex-col">
            <div className="md:w-1/3 w-4/5 m-auto">
              <h1 className="text-4xl lg:text-6xl font-semibold">Extreme Weather Protection</h1>
              <h2 className="my-5 text-xl text-offWhite">Don&apos;t worry about damage from extreme weather.</h2>
              <ol className="lg:text-xl text-lg text-offWhite">
                <li className="flex"><p className="w-10 text-purple-gradient font-bold">01</p> <p>Hail</p></li>
                <li className="flex"><p className="w-10 text-purple-gradient font-bold">02</p> High winds</li>
          ...
          <div className="flex justify-evenly my-10 m-auto md:flex-row flex-col-reverse">
            ...
            <div className="md:w-1/3 w-4/5 m-auto">
              ...
              <ol className="lg:text-xl text-lg">
                <li className="flex"><p className="w-10 text-purple-gradient font-bold">01</p> Application completed in only one day</li>
                <li className="flex"><p className="w-10 text-purple-gradient font-bold">02</p> No dust or odor</li>
                <li className="flex"><p className="w-10 text-purple-gradient font-bold">03</p> Only one treatment needed</li>
