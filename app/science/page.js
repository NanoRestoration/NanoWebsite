...
export default function Science() {
    return <div className="w-full pt-24">
        ...
        <section id="Sealants" className="min-h-screen bg-white text-midnight-blue text-center py-30">
            <h1 className="sm:text-6xl xs:text-5xl text-4xl font-bold my-5">GoNano vs Traditional Sealants</h1>
        ...
        <section id="Classes" className="min-h-fit text-center py-30 ">
            <h1 className="sm:text-6xl xs:text-5xl text-4xl font-bold my-5">Shingle Class Transformation</h1>
            <div>
        ...
        <section id="GoNanoEffect" className="min-h-fit py-30 text-center bg-white text-midnight-blue">
            <h1 className="sm:text-6xl xs:text-5xl text-4xl font-bold my-5">Permanent Structure Modification</h1>
        ...
        <section id="Environment" className="min-h-fit py-30 text-center">
            <h1 className="sm:text-6xl xs:text-5xl text-4xl font-bold my-5">Environmental Impacts</h1>
